                ...
                <form method="POST" action="{{ route('property.update', $property) }}">
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" name="property_no" value="{{ old('property_no', $property->property_no) }}" class="form-control">
                        </div>
                        <div class="col-md-4 mb-3">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" name="on_hand_per_count" value="{{ old('on_hand_per_count', $property->on_hand_per_count) }}"
